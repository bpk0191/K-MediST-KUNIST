...
const HISTORY = [
  { year: '2023', title: '사업 기획 및 협약 체결', desc: '고려대학교 의과대학과 UNIST 간 공동사업 추진을 위한 업무협약(MOU) 체결' },
  { year: '2024', title: 'K-MediST 사업단 출범', desc: '공동학위제 신설 및 KUNIST 공동연구소 개소, 1차 대학원생 모집 시작' },
  { year: '2025', title: '4대 Pillar 연구 본격화', desc: '융합연구 과제 착수 및 글로벌 석학 프로그램 운영, 기술사업화 지원체계 구축' },
  { year: '2026', title: '성과 확산 및 국제화', desc: '연구성과 기반 기술이전·창업 지원 확대 및 국제 공동연구 네트워크 강화' },
]
